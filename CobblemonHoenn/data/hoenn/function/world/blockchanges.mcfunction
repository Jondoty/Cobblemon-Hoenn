...
execute as @a[x=-1800,y=88,z=-1426,dx=4,dy=10,dz=4] at @s if block ~ ~-1 ~ minecraft:dark_oak_leaves run particle block{block_state:{Name:dark_oak_leaves}} -1798 89 -1424 2 3 2 1 100 normal
...
execute as @a[x=-1783,y=88,z=-1448,dx=4,dy=10,dz=4] at @s if block ~ ~-1 ~ minecraft:dark_oak_leaves run particle block{block_state:{Name:dark_oak_leaves}} -1781 89 -1446 2 3 2 1 100 normal
...
execute as @a[x=-1773,y=88,z=-1455,dx=4,dy=10,dz=4] at @s if block ~ ~-1 ~ minecraft:dark_oak_leaves run particle block{block_state:{Name:dark_oak_leaves}} -1771 89 -1453 2 3 2 1 100 normal
...
execute as @a[x=-1724,y=83,z=-1452,dx=4,dy=10,dz=4] at @s if block ~ ~-1 ~ minecraft:dark_oak_leaves run particle block{block_state:{Name:dark_oak_leaves}} -1722 84 -1450 2 3 2 1 100 normal
...
execute as @a[x=-1716,y=78,z=-1420,dx=4,dy=10,dz=4] at @s if block ~ ~-1 ~ minecraft:dark_oak_leaves run particle block{block_state:{Name:dark_oak_leaves}} -1714 79 -1418 2 3 2 1 100 normal
...
execute as @a[x=-1963,y=93,z=-1454,dx=4,dy=10,dz=4] at @s if block ~ ~-1 ~ minecraft:dark_oak_leaves run particle block{block_state:{Name:dark_oak_leaves}} -1961 94 -1452 2 3 2 1 100 normal
...
execute as @a[x=-1971,y=88,z=-1405,dx=4,dy=10,dz=4] at @s if block ~ ~-1 ~ minecraft:dark_oak_leaves run particle block{block_state:{Name:dark_oak_leaves}} -1969 89 -1403 2 3 2 1 100 normal
...
execute as @a[x=-2000,y=88,z=-1424,dx=4,dy=10,dz=4] at @s if block ~ ~-1 ~ minecraft:dark_oak_leaves run particle block{block_state:{Name:dark_oak_leaves}} -1998 89 -1422 2 3 2 1 100 normal
...
execute as @a[x=-2010,y=88,z=-1449,dx=4,dy=10,dz=4] at @s if block ~ ~-1 ~ minecraft:dark_oak_leaves run particle block{block_state:{Name:dark_oak_leaves}} -2008 89 -1447 2 3 2 1 100 normal
