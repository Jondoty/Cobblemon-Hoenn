...
execute as @s[tag=UxieHave,tag=MespritHave,tag=AzelfHave,tag=!PalkiaEncounter] unless entity @e[x=-958,y=100,z=1539,distance=..5,type=minecraft:item_display] run summon minecraft:item_display -958 100 1539 {item:{id:"minecraft:tipped_arrow",Count:1b,components:{"minecraft:custom_model_data":5}},Rotation:[-145f,0.0f]}
execute as @s[tag=DialgaHave,tag=PalkiaHave,tag=!GiratinaEncounter] unless entity @e[x=-958,y=100,z=1539,distance=..5,type=minecraft:item_display] run summon minecraft:item_display -958 100 1539 {item:{id:"minecraft:tipped_arrow",Count:1b,components:{"minecraft:custom_model_data":5}},Rotation:[-145f,0.0f]}
...
gamemode adventure @s[x=-803,y=63,z=1479,dx=17,dy=15,dz=11,tag=FlySkyPillar]
...
tp @s[x=-803,y=63,z=1479,dx=17,dy=15,dz=11,tag=FlySkyPillar] 338 89 -125 0 0
