...
#Runs world portals
execute if entity @e[x=-2070,y=65,z=1410,dy=4,scores={Seed=0}] at @a run execute if block ~ ~ ~ minecraft:magenta_carpet run function hoenn:world/portals
execute if entity @e[x=-2070,y=65,z=1410,dy=4,scores={Seed=1..}] at @a as @a if block ~ ~ ~ minecraft:magenta_carpet run function hoenn:randomizer/randomdoors
...
execute as @a[x=-2035,y=69,z=246,distance=..30,tag=Dialogue169,tag=!Dialogue171] run function hoenn:cutscenes/birchrunningjohto
execute as @a[x=-2035,y=69,z=246,distance=..30,tag=Dialogue172,tag=Dialogue209,tag=!Dialogue173] run function hoenn:cutscenes/birchrunningunova
execute as @a[x=-2035,y=69,z=246,distance=..30,scores={PokemonLeague=2..},tag=Dialogue174,tag=Dialogue209,tag=!Dialogue175] run function hoenn:cutscenes/birchrunningsinnoh
