...
tag @a[tag=!FlyEverGrande,x=2025,y=80,z=-884,dx=338,dy=256,dz=961,tag=!InDialogue,scores={DialogueTrigger=0}] add FlyEverGrande
...
#execute unless entity @e[x=392,y=0,z=2311,dx=501,dy=256,dz=501,type=pixelmon:pixelmon,nbt={ndex:386}] run tag @a[x=392,y=0,z=2311,dx=501,dy=256,dz=501,scores={DialogueTrigger=0},gamemode=adventure,tag=TempDelay] remove Dialogue208
#execute unless entity @e[x=392,y=0,z=2311,dx=501,dy=256,dz=501,type=pixelmon:pixelmon,nbt={ndex:386}] run scoreboard players set @a[x=392,y=0,z=2311,dx=501,dy=256,dz=501,scores={DialogueTrigger=0},gamemode=adventure,tag=TempDelay] DialogueTrigger 208
#execute unless entity @e[x=392,y=0,z=2311,dx=501,dy=256,dz=501,type=pixelmon:pixelmon,nbt={ndex:386}] run tag @a[x=392,y=0,z=2311,dx=501,dy=256,dz=501,scores={DialogueTrigger=0},gamemode=adventure] add TempDelay
