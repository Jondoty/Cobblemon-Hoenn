...
execute as @s[x=-2725,y=48,z=-623,distance=..5,tag=ItemLoot33] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-2725,y=48,z=-623,distance=..5,tag=!ItemLoot33] run givetm falseswipe @s
execute as @s[x=-2725,y=48,z=-623,distance=..5,tag=!ItemLoot33] run tellraw @s {"text":"You received the TM False Swipe!","italic":true,"color":"gray"}
execute as @s[x=-2725,y=48,z=-623,distance=..5,tag=!ItemLoot33] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-2725,y=48,z=-623,distance=..5,tag=!ItemLoot33] run tag @s add ItemLoot33
...
execute as @s[x=2613,y=80,z=-2420,distance=..5,tag=ItemLoot72] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=2613,y=80,z=-2420,distance=..5,tag=!ItemLoot72] run givetm shadowclaw @s
execute as @s[x=2613,y=80,z=-2420,distance=..5,tag=!ItemLoot72] run tellraw @s {"text":"You found the TM Shadow Claw!","italic":true,"color":"gray"}
execute as @s[x=2613,y=80,z=-2420,distance=..5,tag=!ItemLoot72] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=2613,y=80,z=-2420,distance=..5,tag=!ItemLoot72] run tag @s add ItemLoot72
...
execute as @s[x=-2531,y=49,z=812,distance=..5,tag=ItemLoot76] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-2531,y=49,z=812,distance=..5,tag=!ItemLoot76] run givetm sludgebomb @s
execute as @s[x=-2531,y=49,z=812,distance=..5,tag=!ItemLoot76] run tellraw @s {"text":"You found the TM Sludge Bomb!","italic":true,"color":"gray"}
execute as @s[x=-2531,y=49,z=812,distance=..5,tag=!ItemLoot76] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-2531,y=49,z=812,distance=..5,tag=!ItemLoot76] run tag @s add ItemLoot76
...
execute as @s[x=-1933,y=83,z=729,distance=..5,tag=ItemLoot85] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-1933,y=83,z=729,distance=..5,tag=!ItemLoot85] run givetm raindance @s
execute as @s[x=-1933,y=83,z=729,distance=..5,tag=!ItemLoot85] run tellraw @s {"text":"You found the TM Rain Dance!","italic":true,"color":"gray"}
execute as @s[x=-1933,y=83,z=729,distance=..5,tag=!ItemLoot85] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-1933,y=83,z=729,distance=..5,tag=!ItemLoot85] run tag @s add ItemLoot85
...
execute as @s[x=-1830,y=64,z=631,distance=..5,tag=ItemLoot95] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-1830,y=64,z=631,distance=..5,tag=!ItemLoot95] run givetm icebeam @s
execute as @s[x=-1830,y=64,z=631,distance=..5,tag=!ItemLoot95] run tellraw @s {"text":"You found the TM Ice Beam!","italic":true,"color":"gray"}
execute as @s[x=-1830,y=64,z=631,distance=..5,tag=!ItemLoot95] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-1830,y=64,z=631,distance=..5,tag=!ItemLoot95] run tag @s add ItemLoot95
...
execute as @s[x=2637,y=67,z=2862,distance=..5,tag=ItemLoot169] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=2637,y=67,z=2862,distance=..5,tag=!ItemLoot169] run givetm round @s
execute as @s[x=2637,y=67,z=2862,distance=..5,tag=!ItemLoot169] run tellraw @s {"text":"You received the TM Round!","italic":true,"color":"gray"}
execute as @s[x=2637,y=67,z=2862,distance=..5,tag=!ItemLoot169] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=2637,y=67,z=2862,distance=..5,tag=!ItemLoot169] run tag @s add ItemLoot169
...
execute as @s[x=-1496,y=51,z=-661,distance=..5,tag=ItemLoot175] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-1496,y=51,z=-661,distance=..5,tag=!ItemLoot175] run givetm skydrop @s
execute as @s[x=-1496,y=51,z=-661,distance=..5,tag=!ItemLoot175] run tellraw @s {"text":"You received the TM Sky Drop!","italic":true,"color":"gray"}
execute as @s[x=-1496,y=51,z=-661,distance=..5,tag=!ItemLoot175] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-1496,y=51,z=-661,distance=..5,tag=!ItemLoot175] run tag @s add ItemLoot175
...
execute as @s[x=2744,y=88,z=2776,distance=..5,tag=ItemLoot180] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=2744,y=88,z=2776,distance=..5,tag=!ItemLoot180] run givetm uturn @s
execute as @s[x=2744,y=88,z=2776,distance=..5,tag=!ItemLoot180] run tellraw @s {"text":"You found the TM U-turn!","italic":true,"color":"gray"}
execute as @s[x=2744,y=88,z=2776,distance=..5,tag=!ItemLoot180] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=2744,y=88,z=2776,distance=..5,tag=!ItemLoot180] run tag @s add ItemLoot180
...
execute as @s[x=-1407,y=79,z=-889,distance=..5,tag=ItemLoot201] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-1407,y=79,z=-889,distance=..5,tag=!ItemLoot201] run givetm sandstorm @s
execute as @s[x=-1407,y=79,z=-889,distance=..5,tag=!ItemLoot201] run tellraw @s {"text":"You found the TM Sandstorm!","italic":true,"color":"gray"}
execute as @s[x=-1407,y=79,z=-889,distance=..5,tag=!ItemLoot201] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-1407,y=79,z=-889,distance=..5,tag=!ItemLoot201] run tag @s add ItemLoot201
...
execute as @s[x=-1984,y=84,z=-1107,distance=..5,tag=ItemLoot209] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-1984,y=84,z=-1107,distance=..5,tag=!ItemLoot209] run givetm swordsdance @s
execute as @s[x=-1984,y=84,z=-1107,distance=..5,tag=!ItemLoot209] run tellraw @s {"text":"You recieved the TM Swords Dance","italic":true,"color":"gray"}
execute as @s[x=-1984,y=84,z=-1107,distance=..5,tag=!ItemLoot209] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-1984,y=84,z=-1107,distance=..5,tag=!ItemLoot209] run tag @s add ItemLoot209
...
execute as @s[x=-1819,y=155,z=-2892,distance=..5,tag=ItemLoot212] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-1819,y=155,z=-2892,distance=..5,tag=!ItemLoot212] run givetm flamecharge @s
execute as @s[x=-1819,y=155,z=-2892,distance=..5,tag=!ItemLoot212] run tellraw @s {"text":"You found the TM Flame Charge!","italic":true,"color":"gray"}
execute as @s[x=-1819,y=155,z=-2892,distance=..5,tag=!ItemLoot212] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-1819,y=155,z=-2892,distance=..5,tag=!ItemLoot212] run tag @s add ItemLoot212

execute as @s[x=-1968,y=145,z=-2878,distance=..5,tag=ItemLoot214] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-1968,y=145,z=-2878,distance=..5,tag=!ItemLoot214] run givetm rockpolish @s
execute as @s[x=-1968,y=145,z=-2878,distance=..5,tag=!ItemLoot214] run tellraw @s {"text":"You found the TM Rock Polish!","italic":true,"color":"gray"}
execute as @s[x=-1968,y=145,z=-2878,distance=..5,tag=!ItemLoot214] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-1968,y=145,z=-2878,distance=..5,tag=!ItemLoot214] run tag @s add ItemLoot214
...
execute as @s[x=-1979,y=213,z=-3381,distance=..5,tag=ItemLoot223] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-1979,y=213,z=-3381,distance=..5,tag=!ItemLoot223] run givetm incinerate @s
execute as @s[x=-1979,y=213,z=-3381,distance=..5,tag=!ItemLoot223] run tellraw @s {"text":"You found the TM Incinerate!","italic":true,"color":"gray"}
execute as @s[x=-1979,y=213,z=-3381,distance=..5,tag=!ItemLoot223] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-1979,y=213,z=-3381,distance=..5,tag=!ItemLoot223] run tag @s add ItemLoot223

execute as @s[x=-1864,y=38,z=-1270,distance=..5,tag=ItemLoot224] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-1864,y=38,z=-1270,distance=..5,tag=!ItemLoot224] run givetm naturepower @s
execute as @s[x=-1864,y=38,z=-1270,distance=..5,tag=!ItemLoot224] run tellraw @s {"text":"You found the TM Nature Power!","italic":true,"color":"gray"}
execute as @s[x=-1864,y=38,z=-1270,distance=..5,tag=!ItemLoot224] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-1864,y=38,z=-1270,distance=..5,tag=!ItemLoot224] run tag @s add ItemLoot224

execute as @s[x=-1886,y=38,z=-1348,distance=..5,tag=ItemLoot225] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-1886,y=38,z=-1348,distance=..5,tag=!ItemLoot225] run givetm toxic @s
execute as @s[x=-1886,y=38,z=-1348,distance=..5,tag=!ItemLoot225] run tellraw @s {"text":"You found the TM Toxic!","italic":true,"color":"gray"}
execute as @s[x=-1886,y=38,z=-1348,distance=..5,tag=!ItemLoot225] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-1886,y=38,z=-1348,distance=..5,tag=!ItemLoot225] run tag @s add ItemLoot225
...
execute as @s[x=-1819,y=94,z=-1442,distance=..5,tag=ItemLoot230] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-1819,y=94,z=-1442,distance=..5,tag=!ItemLoot230] run givetm doubleteam @s
execute as @s[x=-1819,y=94,z=-1442,distance=..5,tag=!ItemLoot230] run tellraw @s {"text":"You found the TM Double Team!","italic":true,"color":"gray"}
execute as @s[x=-1819,y=94,z=-1442,distance=..5,tag=!ItemLoot230] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-1819,y=94,z=-1442,distance=..5,tag=!ItemLoot230] run tag @s add ItemLoot230
...
execute as @s[x=-2439,y=59,z=-1446,distance=..5,tag=ItemLoot237] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-2439,y=59,z=-1446,distance=..5,tag=!ItemLoot237] run givetm dig @s
execute as @s[x=-2439,y=59,z=-1446,distance=..5,tag=!ItemLoot237] run tellraw @s {"text":"You received the TM Dig!","italic":true,"color":"gray"}
execute as @s[x=-2439,y=59,z=-1446,distance=..5,tag=!ItemLoot237] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-2439,y=59,z=-1446,distance=..5,tag=!ItemLoot237] run tag @s add ItemLoot237

execute as @s[x=-2500,y=89,z=-1411,distance=..5,tag=ItemLoot237] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-2500,y=89,z=-1411,distance=..5,tag=!ItemLoot237] run givetm roar @s
execute as @s[x=-2500,y=89,z=-1411,distance=..5,tag=!ItemLoot237] run tellraw @s {"text":"You received the TM Roar!","italic":true,"color":"gray"}
execute as @s[x=-2500,y=89,z=-1411,distance=..5,tag=!ItemLoot237] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-2500,y=89,z=-1411,distance=..5,tag=!ItemLoot237] run tag @s add ItemLoot238
...
execute as @s[x=2337,y=149,z=-3120,distance=..5,tag=ItemLoot253] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=2337,y=149,z=-3120,distance=..5,tag=!ItemLoot253] run givetm dragonclaw @s
execute as @s[x=2337,y=149,z=-3120,distance=..5,tag=!ItemLoot253] run tellraw @s {"text":"You found the TM Dragon Claw!","italic":true,"color":"gray"}
execute as @s[x=2337,y=149,z=-3120,distance=..5,tag=!ItemLoot253] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=2337,y=149,z=-3120,distance=..5,tag=!ItemLoot253] run tag @s add ItemLoot253
...
execute as @s[x=-956,y=89,z=-1396,distance=..5,tag=ItemLoot279] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-956,y=89,z=-1396,distance=..5,tag=!ItemLoot279] run givetm acrobatics @s
execute as @s[x=-956,y=89,z=-1396,distance=..5,tag=!ItemLoot279] run tellraw @s {"text":"You found the TM Acrobatics!","italic":true,"color":"gray"}
execute as @s[x=-956,y=89,z=-1396,distance=..5,tag=!ItemLoot279] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-956,y=89,z=-1396,distance=..5,tag=!ItemLoot279] run tag @s add ItemLoot279

execute as @s[x=-951,y=74,z=-1296,distance=..5,tag=ItemLoot622] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-951,y=74,z=-1296,distance=..5,tag=!ItemLoot622] run give @s cobblemon:prism_scale
execute as @s[x=-951,y=74,z=-1296,distance=..5,tag=!ItemLoot622] run tellraw @s {"text":"You found a Prism Scale!","italic":true,"color":"gray"}
execute as @s[x=-951,y=74,z=-1296,distance=..5,tag=!ItemLoot622] run playsound minecraft:itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-951,y=74,z=-1296,distance=..5,tag=!ItemLoot622] run tag @s add ItemLoot622
...
execute as @s[x=-609,y=67,z=-1441,distance=..5,tag=ItemLoot287] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-609,y=67,z=-1441,distance=..5,tag=!ItemLoot287] run givetm hiddenpower @s
execute as @s[x=-609,y=67,z=-1441,distance=..5,tag=!ItemLoot287] run tellraw @s {"text":"You received the TM Hidden Power!","italic":true,"color":"gray"}
execute as @s[x=-609,y=67,z=-1441,distance=..5,tag=!ItemLoot287] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-609,y=67,z=-1441,distance=..5,tag=!ItemLoot287] run tag @s add ItemLoot287

execute as @s[x=-572,y=84,z=-1427,distance=..5,tag=ItemLoot288] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-572,y=84,z=-1427,distance=..5,tag=!ItemLoot288] run givetm grassknot @s
execute as @s[x=-572,y=84,z=-1427,distance=..5,tag=!ItemLoot288] run tellraw @s {"text":"You found the TM Grass Knot!","italic":true,"color":"gray"}
execute as @s[x=-572,y=84,z=-1427,distance=..5,tag=!ItemLoot288] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-572,y=84,z=-1427,distance=..5,tag=!ItemLoot288] run tag @s add ItemLoot288
...
execute as @s[x=61,y=68,z=-1055,distance=..5,tag=ItemLoot320] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=61,y=68,z=-1055,distance=..5,tag=!ItemLoot320] run givetm dreameater @s
execute as @s[x=61,y=68,z=-1055,distance=..5,tag=!ItemLoot320] run tellraw @s {"text":"You received the TM Dream Eater!","italic":true,"color":"gray"}
execute as @s[x=61,y=68,z=-1055,distance=..5,tag=!ItemLoot320] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=61,y=68,z=-1055,distance=..5,tag=!ItemLoot320] run tag @s add ItemLoot320
...
execute as @s[x=-9,y=94,z=-1160,distance=..5,tag=ItemLoot322] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-9,y=94,z=-1160,distance=..5,tag=!ItemLoot322] run givetm energyball @s
execute as @s[x=-9,y=94,z=-1160,distance=..5,tag=!ItemLoot322] run tellraw @s {"text":"You found the TM Energy Ball!","italic":true,"color":"gray"}
execute as @s[x=-9,y=94,z=-1160,distance=..5,tag=!ItemLoot322] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-9,y=94,z=-1160,distance=..5,tag=!ItemLoot322] run tag @s add ItemLoot322
...
execute as @s[x=10,y=84,z=-1272,distance=..5,tag=ItemLoot331] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=10,y=84,z=-1272,distance=..5,tag=!ItemLoot331] run givetm solarbeam @s
execute as @s[x=10,y=84,z=-1272,distance=..5,tag=!ItemLoot331] run tellraw @s {"text":"You found the TM Solar Beam!","italic":true,"color":"gray"}
execute as @s[x=10,y=84,z=-1272,distance=..5,tag=!ItemLoot331] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=10,y=84,z=-1272,distance=..5,tag=!ItemLoot331] run tag @s add ItemLoot331

execute as @s[x=61,y=99,z=-1257,distance=..5,tag=ItemLoot332] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=61,y=99,z=-1257,distance=..5,tag=!ItemLoot332] run givetm wildcharge @s
execute as @s[x=61,y=99,z=-1257,distance=..5,tag=!ItemLoot332] run tellraw @s {"text":"You found the TM Wild Charge!","italic":true,"color":"gray"}
execute as @s[x=61,y=99,z=-1257,distance=..5,tag=!ItemLoot332] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=61,y=99,z=-1257,distance=..5,tag=!ItemLoot332] run tag @s add ItemLoot332
...
execute as @s[x=1614,y=66,z=2572,distance=..5,tag=ItemLoot356] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=1614,y=66,z=2572,distance=..5,tag=!ItemLoot356] run givetm shadowball @s
execute as @s[x=1614,y=66,z=2572,distance=..5,tag=!ItemLoot356] run tellraw @s {"text":"You found the TM Shadow Ball","italic":true,"color":"gray"}
execute as @s[x=1614,y=66,z=2572,distance=..5,tag=!ItemLoot356] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=1614,y=66,z=2572,distance=..5,tag=!ItemLoot356] run tag @s add ItemLoot356
...
execute as @s[x=1616,y=122,z=2819,distance=..5,tag=ItemLoot358] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=1616,y=122,z=2819,distance=..5,tag=!ItemLoot358] run givetm willowisp @s
execute as @s[x=1616,y=122,z=2819,distance=..5,tag=!ItemLoot358] run tellraw @s {"text":"You found the TM Will-O-Wisp","italic":true,"color":"gray"}
execute as @s[x=1616,y=122,z=2819,distance=..5,tag=!ItemLoot358] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=1616,y=122,z=2819,distance=..5,tag=!ItemLoot358] run tag @s add ItemLoot358
...
execute as @s[x=-515,y=64,z=-571,distance=..5,tag=ItemLoot382] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-515,y=64,z=-571,distance=..5,tag=!ItemLoot382] run givetm dazzlinggleam @s
execute as @s[x=-515,y=64,z=-571,distance=..5,tag=!ItemLoot382] run tellraw @s {"text":"You received the TM Dazzling Gleam!","italic":true,"color":"gray"}
execute as @s[x=-515,y=64,z=-571,distance=..5,tag=!ItemLoot382] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-515,y=64,z=-571,distance=..5,tag=!ItemLoot382] run tag @s add ItemLoot382
...
execute as @s[x=947,y=99,z=-2323,distance=..5,tag=ItemLoot396] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=947,y=99,z=-2323,distance=..5,tag=!ItemLoot396] run givetm darkpulse @s
execute as @s[x=947,y=99,z=-2323,distance=..5,tag=!ItemLoot396] run tellraw @s {"text":"You found the TM Dark Pulse","italic":true,"color":"gray"}
execute as @s[x=947,y=99,z=-2323,distance=..5,tag=!ItemLoot396] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=947,y=99,z=-2323,distance=..5,tag=!ItemLoot396] run tag @s add ItemLoot396
...
#ItemLoot400 in Starter2

#ItemLoot401 in Starter1
...
execute as @s[x=1375,y=99,z=-2323,distance=..5,tag=ItemLoot408] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=1375,y=99,z=-2323,distance=..5,tag=!ItemLoot408] run givetm darkpulse @s
execute as @s[x=1375,y=99,z=-2323,distance=..5,tag=!ItemLoot408] run tellraw @s {"text":"You found the TM Dark Pulse","italic":true,"color":"gray"}
execute as @s[x=1375,y=99,z=-2323,distance=..5,tag=!ItemLoot408] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=1375,y=99,z=-2323,distance=..5,tag=!ItemLoot408] run tag @s add ItemLoot408
...
#Magma and Aqua bases, Delta Episode zones
execute as @s[x=933,y=181,z=-2395,distance=..5,tag=ItemLoot390] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=933,y=181,z=-2395,distance=..5,tag=!ItemLoot390] run give @s cobblemon:master_ball
execute as @s[x=933,y=181,z=-2395,distance=..5,tag=!ItemLoot390] run tellraw @s {"text":"You found a Master Ball!","italic":true,"color":"gray"}
execute as @s[x=933,y=181,z=-2395,distance=..5,tag=!ItemLoot390] run playsound minecraft:itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=933,y=181,z=-2395,distance=..5,tag=!ItemLoot390] run tag @s add ItemLoot390

execute as @s[x=925,y=167,z=-2384,distance=..5,tag=ItemLoot392] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=925,y=167,z=-2384,distance=..5,tag=!ItemLoot392] run give @s cobblemon:max_elixir
execute as @s[x=925,y=167,z=-2384,distance=..5,tag=!ItemLoot392] run tellraw @s {"text":"You found a Max Elixir!","italic":true,"color":"gray"}
execute as @s[x=925,y=167,z=-2384,distance=..5,tag=!ItemLoot392] run playsound minecraft:itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=925,y=167,z=-2384,distance=..5,tag=!ItemLoot392] run tag @s add ItemLoot392

execute as @s[x=922,y=162,z=-2358,distance=..5,tag=ItemLoot393] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=922,y=162,z=-2358,distance=..5,tag=!ItemLoot393] run scoreboard players add @s Money 5000
execute as @s[x=922,y=162,z=-2358,distance=..5,tag=!ItemLoot393] run tellraw @s {"text":"You found $5,000!","italic":true,"color":"gray"}
execute as @s[x=922,y=162,z=-2358,distance=..5,tag=!ItemLoot393] run playsound minecraft:itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=922,y=162,z=-2358,distance=..5,tag=!ItemLoot393] run tag @s add ItemLoot393

execute as @s[x=987,y=162,z=-2358,distance=..5,tag=ItemLoot394] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=987,y=162,z=-2358,distance=..5,tag=!ItemLoot394] run give @s cobblemon:full_restore
execute as @s[x=987,y=162,z=-2358,distance=..5,tag=!ItemLoot394] run tellraw @s {"text":"You found a Full Restore!","italic":true,"color":"gray"}
execute as @s[x=987,y=162,z=-2358,distance=..5,tag=!ItemLoot394] run playsound minecraft:itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=987,y=162,z=-2358,distance=..5,tag=!ItemLoot394] run tag @s add ItemLoot394

execute as @s[x=977,y=153,z=-2379,distance=..5,tag=ItemLoot395] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=977,y=153,z=-2379,distance=..5,tag=!ItemLoot395] run function hoenn:spawn/escaperope
execute as @s[x=977,y=153,z=-2379,distance=..5,tag=!ItemLoot395] run tellraw @s {"text":"You found an Escape Rope!","italic":true,"color":"gray"}
execute as @s[x=977,y=153,z=-2379,distance=..5,tag=!ItemLoot395] run playsound minecraft:itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=977,y=153,z=-2379,distance=..5,tag=!ItemLoot395] run tag @s add ItemLoot395

execute as @s[x=962,y=153,z=-2421,distance=..5,tag=ItemLoot397] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=962,y=153,z=-2421,distance=..5,tag=!ItemLoot397] run give @s cobblemon:nest_ball
execute as @s[x=962,y=153,z=-2421,distance=..5,tag=!ItemLoot397] run tellraw @s {"text":"You found a Nest Ball!","italic":true,"color":"gray"}
execute as @s[x=962,y=153,z=-2421,distance=..5,tag=!ItemLoot397] run playsound minecraft:itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=962,y=153,z=-2421,distance=..5,tag=!ItemLoot397] run tag @s add ItemLoot397

execute as @s[x=1027,y=154,z=-2476,distance=..5,tag=ItemLoot398] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=1027,y=154,z=-2476,distance=..5,tag=!ItemLoot398] run give @s cobblemon:pp_max
execute as @s[x=1027,y=154,z=-2476,distance=..5,tag=!ItemLoot398] run tellraw @s {"text":"You found a PP Max!","italic":true,"color":"gray"}
execute as @s[x=1027,y=154,z=-2476,distance=..5,tag=!ItemLoot398] run playsound minecraft:itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=1027,y=154,z=-2476,distance=..5,tag=!ItemLoot398] run tag @s add ItemLoot398

execute as @s[x=950,y=154,z=-2457,distance=..5,tag=ItemLoot399] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=950,y=154,z=-2457,distance=..5,tag=!ItemLoot399] run give @s cobblemon:max_revive
execute as @s[x=950,y=154,z=-2457,distance=..5,tag=!ItemLoot399] run tellraw @s {"text":"You found a Max Revive!","italic":true,"color":"gray"}
execute as @s[x=950,y=154,z=-2457,distance=..5,tag=!ItemLoot399] run playsound minecraft:itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=950,y=154,z=-2457,distance=..5,tag=!ItemLoot399] run tag @s add ItemLoot399

execute as @s[x=1400,y=162,z=-2358,distance=..5,tag=ItemLoot402] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=1400,y=162,z=-2358,distance=..5,tag=!ItemLoot402] run scoreboard players add @s Money 5000
execute as @s[x=1400,y=162,z=-2358,distance=..5,tag=!ItemLoot402] run tellraw @s {"text":"You found $5,000!","italic":true,"color":"gray"}
execute as @s[x=1400,y=162,z=-2358,distance=..5,tag=!ItemLoot402] run playsound minecraft:itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=1400,y=162,z=-2358,distance=..5,tag=!ItemLoot402] run tag @s add ItemLoot402

execute as @s[x=1387,y=181,z=-2393,distance=..5,tag=ItemLoot403] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=1387,y=181,z=-2393,distance=..5,tag=!ItemLoot403] run scoreboard players add @s Money 5000
execute as @s[x=1387,y=181,z=-2393,distance=..5,tag=!ItemLoot403] run tellraw @s {"text":"You found $5,000!","italic":true,"color":"gray"}
execute as @s[x=1387,y=181,z=-2393,distance=..5,tag=!ItemLoot403] run playsound minecraft:itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=1387,y=181,z=-2393,distance=..5,tag=!ItemLoot403] run tag @s add ItemLoot403

execute as @s[x=1335,y=162,z=-2358,distance=..5,tag=ItemLoot404] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=1335,y=162,z=-2358,distance=..5,tag=!ItemLoot404] run give @s cobblemon:full_restore
execute as @s[x=1335,y=162,z=-2358,distance=..5,tag=!ItemLoot404] run tellraw @s {"text":"You found a Full Restore!","italic":true,"color":"gray"}
execute as @s[x=1335,y=162,z=-2358,distance=..5,tag=!ItemLoot404] run playsound minecraft:itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=1335,y=162,z=-2358,distance=..5,tag=!ItemLoot404] run tag @s add ItemLoot404

execute as @s[x=1397,y=167,z=-2384,distance=..5,tag=ItemLoot405] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=1397,y=167,z=-2384,distance=..5,tag=!ItemLoot405] run give @s cobblemon:max_elixir
execute as @s[x=1397,y=167,z=-2384,distance=..5,tag=!ItemLoot405] run tellraw @s {"text":"You found a Max Elixir!","italic":true,"color":"gray"}
execute as @s[x=1397,y=167,z=-2384,distance=..5,tag=!ItemLoot405] run playsound minecraft:itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=1397,y=167,z=-2384,distance=..5,tag=!ItemLoot405] run tag @s add ItemLoot405

execute as @s[x=1345,y=153,z=-2379,distance=..5,tag=ItemLoot406] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=1345,y=153,z=-2379,distance=..5,tag=!ItemLoot406] run function hoenn:spawn/escaperope
execute as @s[x=1345,y=153,z=-2379,distance=..5,tag=!ItemLoot406] run tellraw @s {"text":"You found an Escape Rope!","italic":true,"color":"gray"}
execute as @s[x=1345,y=153,z=-2379,distance=..5,tag=!ItemLoot406] run playsound minecraft:itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=1345,y=153,z=-2379,distance=..5,tag=!ItemLoot406] run tag @s add ItemLoot406

execute as @s[x=1360,y=153,z=-2421,distance=..5,tag=ItemLoot407] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=1360,y=153,z=-2421,distance=..5,tag=!ItemLoot407] run give @s cobblemon:nest_ball
execute as @s[x=1360,y=153,z=-2421,distance=..5,tag=!ItemLoot407] run tellraw @s {"text":"You found a Nest Ball!","italic":true,"color":"gray"}
execute as @s[x=1360,y=153,z=-2421,distance=..5,tag=!ItemLoot407] run playsound minecraft:itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=1360,y=153,z=-2421,distance=..5,tag=!ItemLoot407] run tag @s add ItemLoot407

execute as @s[x=1295,y=154,z=-2476,distance=..5,tag=ItemLoot409] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=1295,y=154,z=-2476,distance=..5,tag=!ItemLoot409] run give @s cobblemon:pp_max
execute as @s[x=1295,y=154,z=-2476,distance=..5,tag=!ItemLoot409] run tellraw @s {"text":"You found a PP Max!","italic":true,"color":"gray"}
execute as @s[x=1295,y=154,z=-2476,distance=..5,tag=!ItemLoot409] run playsound minecraft:itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=1295,y=154,z=-2476,distance=..5,tag=!ItemLoot409] run tag @s add ItemLoot409

execute as @s[x=1372,y=154,z=-2457,distance=..5,tag=ItemLoot410] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=1372,y=154,z=-2457,distance=..5,tag=!ItemLoot410] run give @s cobblemon:max_revive
execute as @s[x=1372,y=154,z=-2457,distance=..5,tag=!ItemLoot410] run tellraw @s {"text":"You found a Max Revive!","italic":true,"color":"gray"}
execute as @s[x=1372,y=154,z=-2457,distance=..5,tag=!ItemLoot410] run playsound minecraft:itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=1372,y=154,z=-2457,distance=..5,tag=!ItemLoot410] run tag @s add ItemLoot410

execute as @s[x=1389,y=181,z=-2395,distance=..5,tag=ItemLoot411] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=1389,y=181,z=-2395,distance=..5,tag=!ItemLoot411] run give @s cobblemon:master_ball
execute as @s[x=1389,y=181,z=-2395,distance=..5,tag=!ItemLoot411] run tellraw @s {"text":"You found a Master Ball!","italic":true,"color":"gray"}
execute as @s[x=1389,y=181,z=-2395,distance=..5,tag=!ItemLoot411] run playsound minecraft:itemget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=1389,y=181,z=-2395,distance=..5,tag=!ItemLoot411] run tag @s add ItemLoot411
...
execute as @s[x=1552,y=55,z=-983,distance=..5,tag=ItemLoot430] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=1552,y=55,z=-983,distance=..5,tag=!ItemLoot430] run givetm quash @s
execute as @s[x=1552,y=55,z=-983,distance=..5,tag=!ItemLoot430] run tellraw @s {"text":"You received the TM Quash!","italic":true,"color":"gray"}
execute as @s[x=1552,y=55,z=-983,distance=..5,tag=!ItemLoot430] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=1552,y=55,z=-983,distance=..5,tag=!ItemLoot430] run tag @s add ItemLoot430
...
execute as @s[x=2954,y=102,z=-2912,distance=..5,tag=ItemLoot448] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=2954,y=102,z=-2912,distance=..5,tag=!ItemLoot448] run givetm frostbreath @s
execute as @s[x=2954,y=102,z=-2912,distance=..5,tag=!ItemLoot448] run tellraw @s {"text":"You found the TM Frost Breath","italic":true,"color":"gray"}
execute as @s[x=2954,y=102,z=-2912,distance=..5,tag=!ItemLoot448] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=2954,y=102,z=-2912,distance=..5,tag=!ItemLoot448] run tag @s add ItemLoot448
...
execute as @s[x=2962,y=70,z=-2898,distance=..5,tag=ItemLoot448] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=2962,y=70,z=-2898,distance=..5,tag=!ItemLoot448] run givetm hail @s
execute as @s[x=2962,y=70,z=-2898,distance=..5,tag=!ItemLoot448] run tellraw @s {"text":"You found the TM Hail","italic":true,"color":"gray"}
execute as @s[x=2962,y=70,z=-2898,distance=..5,tag=!ItemLoot448] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=2962,y=70,z=-2898,distance=..5,tag=!ItemLoot448] run tag @s add ItemLoot448
...
execute as @s[x=284,y=143,z=-158,distance=..5,tag=ItemLoot498] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=284,y=143,z=-158,distance=..5,tag=!ItemLoot498] run givetm explosion @s
execute as @s[x=284,y=143,z=-158,distance=..5,tag=!ItemLoot498] run tellraw @s {"text":"You found the TM Explosion","italic":true,"color":"gray"}
execute as @s[x=284,y=143,z=-158,distance=..5,tag=!ItemLoot498] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=284,y=143,z=-158,distance=..5,tag=!ItemLoot498] run tag @s add ItemLoot498
...
execute as @s[x=-97,y=32,z=233,distance=..5,tag=ItemLoot505] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-97,y=32,z=233,distance=..5,tag=!ItemLoot505] run givetm fling @s
execute as @s[x=-97,y=32,z=233,distance=..5,tag=!ItemLoot505] run tellraw @s {"text":"You received the TM Fling!","italic":true,"color":"gray"}
execute as @s[x=-97,y=32,z=233,distance=..5,tag=!ItemLoot505] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-97,y=32,z=233,distance=..5,tag=!ItemLoot505] run tag @s add ItemLoot505

execute as @s[x=8,y=29,z=307,distance=..5,tag=ItemLoot506] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=8,y=29,z=307,distance=..5,tag=!ItemLoot506] run givetm psyshock @s
execute as @s[x=8,y=29,z=307,distance=..5,tag=!ItemLoot506] run tellraw @s {"text":"You received the TM Psyshock!","italic":true,"color":"gray"}
execute as @s[x=8,y=29,z=307,distance=..5,tag=!ItemLoot506] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=8,y=29,z=307,distance=..5,tag=!ItemLoot506] run tag @s add ItemLoot506
...
execute as @s[x=-430,y=64,z=337,distance=..5,tag=ItemLoot509] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-430,y=64,z=337,distance=..5,tag=!ItemLoot509] run givetm sludgewave @s
execute as @s[x=-430,y=64,z=337,distance=..5,tag=!ItemLoot509] run tellraw @s {"text":"You found the TM Sludge Wave","italic":true,"color":"gray"}
execute as @s[x=-430,y=64,z=337,distance=..5,tag=!ItemLoot509] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-430,y=64,z=337,distance=..5,tag=!ItemLoot509] run tag @s add ItemLoot509
...
execute as @s[x=-828,y=64,z=205,distance=..5,tag=ItemLoot514] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-828,y=64,z=205,distance=..5,tag=!ItemLoot514] run givetm psyshock @s
execute as @s[x=-828,y=64,z=205,distance=..5,tag=!ItemLoot514] run tellraw @s {"text":"You received the TM Psyshock!","italic":true,"color":"gray"}
execute as @s[x=-828,y=64,z=205,distance=..5,tag=!ItemLoot514] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-828,y=64,z=205,distance=..5,tag=!ItemLoot514] run tag @s add ItemLoot514
...
execute as @s[x=-1075,y=64,z=325,distance=..5,tag=ItemLoot520] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-1075,y=64,z=325,distance=..5,tag=!ItemLoot520] run givetm rockslide @s
execute as @s[x=-1075,y=64,z=325,distance=..5,tag=!ItemLoot520] run tellraw @s {"text":"You found the TM Rock Slide","italic":true,"color":"gray"}
execute as @s[x=-1075,y=64,z=325,distance=..5,tag=!ItemLoot520] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-1075,y=64,z=325,distance=..5,tag=!ItemLoot520] run tag @s add ItemLoot520
...
execute as @s[x=2305,y=139,z=-151,distance=..5,tag=ItemLoot522] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=2305,y=139,z=-151,distance=..5,tag=!ItemLoot522] run givetm psychic @s
execute as @s[x=2305,y=139,z=-151,distance=..5,tag=!ItemLoot522] run tellraw @s {"text":"You found the TM Psychic","italic":true,"color":"gray"}
execute as @s[x=2305,y=139,z=-151,distance=..5,tag=!ItemLoot522] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=2305,y=139,z=-151,distance=..5,tag=!ItemLoot522] run tag @s add ItemLoot522
...
execute as @s[x=1344,y=77,z=-2707,distance=..5,tag=ItemLoot531] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=1344,y=77,z=-2707,distance=..5,tag=!ItemLoot531] run givetm flamethrower @s
execute as @s[x=1344,y=77,z=-2707,distance=..5,tag=!ItemLoot531] run tellraw @s {"text":"You found the TM Flamethrower","italic":true,"color":"gray"}
execute as @s[x=1344,y=77,z=-2707,distance=..5,tag=!ItemLoot531] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=1344,y=77,z=-2707,distance=..5,tag=!ItemLoot531] run tag @s add ItemLoot531
...
execute as @s[x=1574,y=110,z=-2916,distance=..5,tag=ItemLoot534] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=1574,y=110,z=-2916,distance=..5,tag=!ItemLoot534] run givetm xscissor @s
execute as @s[x=1574,y=110,z=-2916,distance=..5,tag=!ItemLoot534] run tellraw @s {"text":"You found the TM X-Scissor","italic":true,"color":"gray"}
execute as @s[x=1574,y=110,z=-2916,distance=..5,tag=!ItemLoot534] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=1574,y=110,z=-2916,distance=..5,tag=!ItemLoot534] run tag @s add ItemLoot534

execute as @s[x=837,y=94,z=1454,distance=..5,tag=ItemLoot536] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=837,y=94,z=1454,distance=..5,tag=!ItemLoot536] run givetm brickbreak @s
execute as @s[x=837,y=94,z=1454,distance=..5,tag=!ItemLoot536] run tellraw @s {"text":"You received the TM Brick Break!","italic":true,"color":"gray"}
execute as @s[x=837,y=94,z=1454,distance=..5,tag=!ItemLoot536] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=837,y=94,z=1454,distance=..5,tag=!ItemLoot536] run tag @s add ItemLoot536
...
execute as @s[x=868,y=60,z=1659,distance=..5,tag=ItemLoot542] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=868,y=60,z=1659,distance=..5,tag=!ItemLoot542] run givetm infestation @s
execute as @s[x=868,y=60,z=1659,distance=..5,tag=!ItemLoot542] run tellraw @s {"text":"You received the TM Infestation!","italic":true,"color":"gray"}
execute as @s[x=868,y=60,z=1659,distance=..5,tag=!ItemLoot542] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=868,y=60,z=1659,distance=..5,tag=!ItemLoot542] run tag @s add ItemLoot542
...
execute as @s[x=938,y=107,z=-2836,distance=..5,tag=ItemLoot549] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=938,y=107,z=-2836,distance=..5,tag=!ItemLoot549] run givetm scald @s
execute as @s[x=938,y=107,z=-2836,distance=..5,tag=!ItemLoot549] run tellraw @s {"text":"You found the TM Scald","italic":true,"color":"gray"}
execute as @s[x=938,y=107,z=-2836,distance=..5,tag=!ItemLoot549] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=938,y=107,z=-2836,distance=..5,tag=!ItemLoot549] run tag @s add ItemLoot549

execute as @s[x=1026,y=90,z=-3146,distance=..5,tag=ItemLoot550] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=1026,y=90,z=-3146,distance=..5,tag=!ItemLoot550] run givetm earthquake @s
execute as @s[x=1026,y=90,z=-3146,distance=..5,tag=!ItemLoot550] run tellraw @s {"text":"You found the TM Earthquake","italic":true,"color":"gray"}
execute as @s[x=1026,y=90,z=-3146,distance=..5,tag=!ItemLoot550] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=1026,y=90,z=-3146,distance=..5,tag=!ItemLoot550] run tag @s add ItemLoot550

execute as @s[x=1538,y=124,z=-2410,distance=..5,tag=ItemLoot551] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=1538,y=124,z=-2410,distance=..5,tag=!ItemLoot551] run givetm sunnyday @s
execute as @s[x=1538,y=124,z=-2410,distance=..5,tag=!ItemLoot551] run tellraw @s {"text":"You found the TM Sunny Day!","italic":true,"color":"gray"}
execute as @s[x=1538,y=124,z=-2410,distance=..5,tag=!ItemLoot551] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=1538,y=124,z=-2410,distance=..5,tag=!ItemLoot551] run tag @s add ItemLoot551
...
execute as @s[x=2440,y=82,z=-1336,distance=..5,tag=ItemLoot558] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=2440,y=82,z=-1336,distance=..5,tag=!ItemLoot558] run givetm embargo @s
execute as @s[x=2440,y=82,z=-1336,distance=..5,tag=!ItemLoot558] run tellraw @s {"text":"You found the TM Embargo!","italic":true,"color":"gray"}
execute as @s[x=2440,y=82,z=-1336,distance=..5,tag=!ItemLoot558] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=2440,y=82,z=-1336,distance=..5,tag=!ItemLoot558] run tag @s add ItemLoot558
...
execute as @s[x=2465,y=42,z=790,distance=..5,tag=ItemLoot563] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=2465,y=42,z=790,distance=..5,tag=!ItemLoot563] run givetm swagger @s
execute as @s[x=2465,y=42,z=790,distance=..5,tag=!ItemLoot563] run tellraw @s {"text":"You found the TM Swagger!","italic":true,"color":"gray"}
execute as @s[x=2465,y=42,z=790,distance=..5,tag=!ItemLoot563] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=2465,y=42,z=790,distance=..5,tag=!ItemLoot563] run tag @s add ItemLoot563
...
execute as @s[x=1778,y=76,z=-1678,distance=..5,tag=ItemLoot585] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=1778,y=76,z=-1678,distance=..5,tag=!ItemLoot585] run givetm flashcannon @s
execute as @s[x=1778,y=76,z=-1678,distance=..5,tag=!ItemLoot585] run tellraw @s {"text":"You found the TM Flash Cannon!","italic":true,"color":"gray"}
execute as @s[x=1778,y=76,z=-1678,distance=..5,tag=!ItemLoot585] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=1778,y=76,z=-1678,distance=..5,tag=!ItemLoot585] run tag @s add ItemLoot585

execute as @s[x=-58,y=99,z=818,distance=..5,tag=ItemLoot586] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-58,y=99,z=818,distance=..5,tag=!ItemLoot586] run givetm substitute @s
execute as @s[x=-58,y=99,z=818,distance=..5,tag=!ItemLoot586] run tellraw @s {"text":"You found the TM Substitute!","italic":true,"color":"gray"}
execute as @s[x=-58,y=99,z=818,distance=..5,tag=!ItemLoot586] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-58,y=99,z=818,distance=..5,tag=!ItemLoot586] run tag @s add ItemLoot586
...
execute as @s[x=-1039,z=64,z=2577,distance=..5,tag=ItemLoot596] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-1039,z=64,z=2577,distance=..5,tag=!ItemLoot596] run givetm gyroball @s
execute as @s[x=-1039,z=64,z=2577,distance=..5,tag=!ItemLoot596] run tellraw @s {"text":"You found the TM Gyro Ball!","italic":true,"color":"gray"}
execute as @s[x=-1039,z=64,z=2577,distance=..5,tag=!ItemLoot596] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-1039,z=64,z=2577,distance=..5,tag=!ItemLoot596] run tag @s add ItemLoot596
...
execute as @s[x=-29,y=15,z=2865,distance=..5,tag=ItemLoot604] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-29,y=15,z=2865,distance=..5,tag=!ItemLoot604] run givetm snarl @s
execute as @s[x=-29,y=15,z=2865,distance=..5,tag=!ItemLoot604] run tellraw @s {"text":"You found the TM Snarl!","italic":true,"color":"gray"}
execute as @s[x=-29,y=15,z=2865,distance=..5,tag=!ItemLoot604] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-29,y=15,z=2865,distance=..5,tag=!ItemLoot604] run tag @s add ItemLoot604
...
execute as @s[x=-751,y=80,z=2576,distance=..5,tag=ItemLoot606] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=-751,y=80,z=2576,distance=..5,tag=!ItemLoot606] run givetm poisonjab @s
execute as @s[x=-751,y=80,z=2576,distance=..5,tag=!ItemLoot606] run tellraw @s {"text":"You found the TM Poison Jab!","italic":true,"color":"gray"}
execute as @s[x=-751,y=80,z=2576,distance=..5,tag=!ItemLoot606] run playsound minecraft:tmget ambient @s ~ ~ ~ 1 1 1
execute as @s[x=-751,y=80,z=2576,distance=..5,tag=!ItemLoot606] run tag @s add ItemLoot606
