...
execute as @e[x=-2070,y=65,z=1410,dy=3,tag=!Birch1Initiate] run pokespawnat -2038 69 228 poochyena level=3 uncatchable

execute as @e[x=-2070,y=65,z=1410,dy=3,tag=!Birch1Initiate] run npcspawnat -2051 69 228 birch_generic
...
#Bottom Left box, tps north
execute as @e[x=-2052,y=68,z=223,dx=2,dy=10,dz=6,type=cobblemon:pokemon,nbt={Pokemon:{Species:"cobblemon:poochyena"}}] at @s run tp @s ~ ~ ~-0.30 180 ~

#Top left box, tps west
execute as @e[x=-2052,y=68,z=220,dx=12,dy=10,dz=2,type=cobblemon:pokemon,nbt={Pokemon:{Species:"cobblemon:poochyena"}}] at @s run tp @s ~0.30 ~ ~ -90 ~

#Top right box, tps south
execute as @e[x=-2039,y=68,z=220,dx=2,dy=10,dz=6,type=cobblemon:pokemon,nbt={Pokemon:{Species:"cobblemon:poochyena"}}] at @s run tp @s ~ ~ ~0.30 0 ~

#Bottom right box, tps east
execute as @e[x=-2049,y=68,z=227,dx=12,dy=10,dz=2,type=cobblemon:pokemon,nbt={Pokemon:{Species:"cobblemon:poochyena"}}] at @s run tp @s ~-0.30 ~ ~ 90 ~
...
execute as @e[x=-2070,y=65,z=1410,dy=3,tag=!Birch1Initiate] run tp @e[type=cobblemon:npc,x=-2054,y=68,z=217,dx=20,dy=10,dz=15] 10000000 -50000 -10000000
execute as @e[x=-2070,y=65,z=1410,dy=3,tag=!Birch1Initiate] run tp @e[type=cobblemon:pokemon,x=-2054,y=68,z=217,dx=20,dy=10,dz=15] 10000000 -50000 -10000000
