...
execute as @s[scores={Friendship=1..}] run tellraw @s {"text":"<Beauty Salon> There! All done! If you'd like another massage for your Pokémon, come back tomorrow!"}
execute as @s[scores={Friendship=1..}] run playsound minecraft:entity.player.levelup ambient @s ~ ~ ~ 1 1 1
execute as @s[scores={Friendship=1..}] run tag @s remove BeautyCD
